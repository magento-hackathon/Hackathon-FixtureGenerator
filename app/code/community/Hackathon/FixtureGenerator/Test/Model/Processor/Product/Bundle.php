...
class Hackathon_FixtureGenerator_Test_Model_Processor_Product_Bundle extends EcomDev_PHPUnit_Test_Case {

    protected $processor = null;

    protected function setUp()
    {
        $this->processor = Mage::getModel('hackathon_fixturegenerator/processor_product_bundle');
    }
